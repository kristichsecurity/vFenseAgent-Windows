...
namespace PatchPayload
{
    public static class Security
    {
        ...
        {
            rgbIv = new byte[] { 0x12, 0x11, 0x1, 0xB, 0x5, 0x6, 0x1, 0x8, 0xA, 0x4, 0xC, 0xE, 0xE, 0xA, 0x11, 0x12 };
            key = new byte[] { 0x12, 0x11, 0x1, 0xB, 0x5, 0x6, 0x1, 0x8, 0xA, 0x4, 0xC, 0xE, 0xE, 0xA, 0x11, 0x12 };
